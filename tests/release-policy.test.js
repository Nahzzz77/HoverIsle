...
test('release version and public download entry points stay aligned', () => {
  ...
  assert.match(websiteContent, /DOWNLOAD_URL\s*=\s*"https:\/\/github\.com\/Nahzzz77\/HoverIsle\/releases\/latest"/);
  assert.match(websiteDownload, /LATEST_RELEASE_API_URL\s*=\s*"https:\/\/api\.github\.com\/repos\/Nahzzz77\/HoverIsle\/releases\/latest"/);
});

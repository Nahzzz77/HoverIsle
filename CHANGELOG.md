...
本文件记录悬岛（HoverIsle）的重要功能、修复与发布变更。尚未发布的改动统一进入「未发布」，创建新版本标签时再归档到对应版本。

## [未发布]

### 品牌

- 将公开产品重品牌为「悬岛 / HoverIsle」，更新应用标识、图标、权限提示、安装包名称、官网文案与分享封面；保留原项目 MIT 许可和版权来源。
...
[未发布]: https://github.com/Nahzzz77/HoverIsle/compare/v1.0.5...HEAD
[1.0.5]: https://github.com/Nahzzz77/HoverIsle/compare/v1.0.4...v1.0.5
[1.0.4]: https://github.com/Nahzzz77/HoverIsle/compare/v1.0.3...v1.0.4
[1.0.3]: https://github.com/Nahzzz77/HoverIsle/compare/v1.0.2...v1.0.3
[1.0.2]: https://github.com/Nahzzz77/HoverIsle/compare/v1.0.1...v1.0.2
[1.0.1]: https://github.com/Nahzzz77/HoverIsle/compare/v1.0.0...v1.0.1
[1.0.0]: https://github.com/Nahzzz77/HoverIsle/releases/tag/v1.0.0

    ...
    <section className={`hero-section hero-photographic${entranceComplete ? " is-ready" : ""}`} data-section="hero" data-hero-boot={effectiveBootPhase} id="top">
        ...
        <div className="hero-screen">
          ...
          >
            ...
            >
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="hero-panel-image hero-panel-image-expanded" src={assetPath("/product-captures/home.jpg")} alt="悬岛真实首页展开态" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="hero-panel-image hero-panel-image-collapsed" src={assetPath("/hero/panel-collapsed.png")} alt="悬岛真实折叠态" />
              <button
                className="hero-panel-trigger"
                type="button"
                aria-expanded={expanded}
                aria-label={expanded ? "折叠悬岛" : "展开悬岛"}
      ...
      >
        <a className="brand-lockup" href="#top">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={assetPath("/hoverisle-icon.png")} alt="" width="34" height="34" />
          <span>HOVERISLE</span>
        </a>

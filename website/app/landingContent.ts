...
export const DOWNLOAD_URL = "https://github.com/Nahzzz77/HoverIsle/releases/latest";
export const GITHUB_URL = "https://github.com/Nahzzz77/HoverIsle";
...
export const MARQUEE_ITEMS: MediaItem[] = [
  { id: "todo", src: assetPath("/product-captures/todo.webp"), fallbackSrc: "", kind: "image", alt: "悬岛待办完整面板" },
  { id: "clipboard", src: assetPath("/product-captures/clipboard.webp"), fallbackSrc: "", kind: "image", alt: "悬岛剪贴完整面板" },
  { id: "notes", src: assetPath("/product-captures/notes.webp"), fallbackSrc: "", kind: "image", alt: "悬岛笔记完整面板" },
  { id: "links", src: assetPath("/product-captures/links.webp"), fallbackSrc: "", kind: "image", alt: "悬岛链接完整面板" },
  { id: "recordings", src: assetPath("/product-captures/recordings.webp"), fallbackSrc: "", kind: "image", alt: "悬岛录制完整面板" },
  { id: "credentials", src: assetPath("/product-captures/credentials.webp"), fallbackSrc: "", kind: "image", alt: "悬岛密钥完整面板" },
];

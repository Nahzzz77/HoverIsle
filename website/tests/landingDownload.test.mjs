...
test("latest release selection returns the installable Apple Silicon DMG", async () => {
  ...
  const release = {
    ...
    assets: [
      {
        name: "HoverIsle-1.0.2-arm64.dmg.sha256",
        content_type: "application/octet-stream",
        state: "uploaded",
        browser_download_url: "https://example.com/checksum",
      },
      {
        name: "HoverIsle-1.0.2-arm64.dmg",
        content_type: "application/x-apple-diskimage",
        state: "uploaded",
        browser_download_url: "https://example.com/HoverIsle-1.0.2-arm64.dmg",
      },
      {
        name: "HoverIsle-1.0.4-arm64.dmg",
        content_type: "application/x-apple-diskimage",
        state: "uploaded",
        browser_download_url: "https://example.com/HoverIsle-1.0.4-arm64.dmg",
      },
    ],
  };

  assert.equal(selectMacDownloadUrl(release), "https://example.com/HoverIsle-1.0.4-arm64.dmg");
});
